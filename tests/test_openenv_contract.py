...
class OpenEnvContractTests(unittest.TestCase):
    def test_openenv_yaml_references_live_paths(self) -> None:
        ...
        self.assertEqual(payload["spec_version"], 1)
        self.assertEqual(payload["runtime"], "fastapi")
        self.assertEqual(payload["app"], "server.app:app")
        self.assertEqual(payload["port"], 7860)
        ...
        self.assertEqual(payload["benchmark_runtime"]["reset_strategy"], "in_cluster_restore")
