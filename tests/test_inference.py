...
class InferenceHelpersTests(unittest.TestCase):
    ...
    def test_emit_start_and_end_use_required_line_format(self) -> None:
        with patch("builtins.print") as mocked_print:
            ...
            emit_end(success=True, steps=2, score=1.0, rewards=[0.0, 1.0])
        ...
        self.assertEqual(
            ...
            "[END] success=true steps=2 score=0.999 rewards=0.00,1.00",
        )
    ...
    def test_main_emits_end_when_credentials_are_missing(self) -> None:
        ...
        self.assertEqual(stdout_lines[-1], "[END] success=false steps=0 score=0.001 rewards=")
